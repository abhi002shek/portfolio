    ...
    <section id="project" className="relative py-24 px-6">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          className="mb-16"
        >
          <p className="font-mono text-accent text-sm tracking-widest mb-3">04 / PROJECTS</p>
          ...
          {projects.map((project, idx) => (
            ...
            >
              ...
              <div className="border-b border-border/40 px-8 py-5 flex items-center justify-between">
                ...
                <span className="font-mono text-xs text-muted truncate max-w-xs">{project.link}</span>
              </div>
